...
public class HashMapTest {
    ...
    public static void main(String[] args) {
        ...
        Map<String, String> nameAddress = new HashMap<>(4);
        ...
        //(key，value) ---> (daming,杭州市西湖区)
        print(nameAddress, "daming");
        ...
        //(key，value) ---> (daming,test2)
        print(nameAddress,"daming");
        nameAddress.replace("daming","test3");
        //(key，value) ---> (daming,test3)
        print(nameAddress,"daming");


        nameAddress.put("daming","test4");
        //(key，value) ---> (daming,test4)
        print(nameAddress,"daming");
